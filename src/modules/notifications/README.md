...
> Skeleton only. This module does not yet have production-code
> equivalents under `src/` to migrate — it will be introduced from
> scratch during migration Phase 3 (see
