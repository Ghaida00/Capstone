// Vendored from https://jslib.k6.io/k6-summary/0.0.2/index.js
// k6 official summary helper (Grafana Labs, Apache-2.0).
//
// Vendored locally instead of imported over the network so that
// k6 runs (notably multi-hour soaks and offline/CI runs) never
// depend on a CDN fetch at init. Exposes `textSummary`, which
// reproduces k6's native end-of-test summary. Kept byte-identical
// to upstream below this header — re-fetch the URL above to diff.
//
